...
Thank you for looking. This page is the short version; the working conventions every change is held
to are in [CLAUDE.md](../CLAUDE.md), and tests enforce many of them.
