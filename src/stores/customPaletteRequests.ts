 ...
 * chosen and then a `.gpl` would otherwise pin whichever finished last. A paste, a reduction and
 * Clear retire whatever is still being read, as later choices than it. Beside the stores rather than
 * in `useCustomPaletteIntake`, because the palette outlives the panel that reads into it.
 */
