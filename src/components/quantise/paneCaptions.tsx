 ...
 * of sheet on both sides, the window that holds the two extents equal, the shift a leading cell of
 * another width moves the result by — and this decides *prose*. Five captions and four reasons for an empty
