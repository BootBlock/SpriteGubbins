    ...
    <section className="glass-panel rounded-2xl border border-foundry-700 p-4 shadow-lg transition-colors duration-585 hover:border-tab/40">
      ...
      {isKeying && (
        <p className="mt-3 text-xs leading-relaxed text-ink-muted">
          ...
          goes, and stop before the sprite does. A field that has been shaded darker or washed paler still
          counts as close, so the setting that clears it stays well short of the settings that would reach
          your artwork. Above <span className="font-mono">exact</span> it also erodes the pixel touching the
          field, which is what removes the halo an anti-aliased edge leaves behind.
        </p>
      )}
    </section>
  );
