...
/**
 * The sheen and the chip that say a newer result is on its way, over whichever frame is waiting.
 *
...
export function WorkingOverlay() {
  return (
    <>
      ...
      />
      {/* `Badge` says "live", and the wrapper is the only thing it cannot say for itself: where to
          sit, and what to sit *on*. The dark ground is the wrapper's because this chip lands on the
          user's image rather than on the app's own panel, where the badge's own translucent fill has
          nothing dependable behind it. */}
