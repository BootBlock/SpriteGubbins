...
export function ExternalLink({ href, children }: ExternalLinkProps) {
  return (
    <a
      ...
      className="rounded-sm font-semibold text-accent-soft underline decoration-accent/40 underline-offset-4 transition-colors duration-300 hover:text-ink hover:decoration-accent"
    >
      {children}
