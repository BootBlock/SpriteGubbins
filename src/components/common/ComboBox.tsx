    ...
    <div className="relative" ref={containerRef}>
      ...
      <div className="relative flex items-center" ref={fieldRef}>
        <input
          ...
          className="w-full rounded-xl border border-foundry-600 bg-foundry-950/80 py-2 pr-9 pl-3 font-sans text-xs text-ink shadow-inner transition-colors duration-390 hover:border-accent/40 focus:border-accent"
        />
        ...
        >
          <svg
            className={`size-4 transition-transform duration-390 ${combo.isOpen ? 'rotate-180 text-accent-soft' : ''}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
