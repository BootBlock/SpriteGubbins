 ...
 * state uses for the same purpose.
 *
 * **The sheen is a layer over the surface, not a class beside it**, and the reason is that
 * `shimmer-surface` is a `background-image`,
