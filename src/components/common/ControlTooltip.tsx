 ...
 * toolbar, the preset library, the history drawer, the quantiser's buttons. There are eighty-seven
 * of those, and a second glyph beside each would be eighty-seven more targets in rows that are
