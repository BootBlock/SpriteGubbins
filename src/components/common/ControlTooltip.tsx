 ...
 * toolbar, the preset library, the history drawer, the quantiser's buttons. There are eighty
 * of those, and a second glyph beside each would be eighty more targets in rows that are
