 ...
 * someone.
 *
 * It carries no guidance card, as a deliberate exception rather than an oversight. Two reasons,
 * and either would be enough: the link's own text is already the whole
