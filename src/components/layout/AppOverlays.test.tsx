 ...
 * exist, and the contents arriving into the same one. How the frame itself opens and closes —
 * including the close that has to reach a dialog still in the document, or the platform restores no
 * focus — is `Modal.test.tsx`'s.
 */
