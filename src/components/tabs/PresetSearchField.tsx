    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-foundry-600 bg-foundry-950/80 py-2 pr-9 pl-8 text-xs text-ink shadow-inner transition-colors duration-200 hover:border-accent/40 focus:border-accent [&::-webkit-search-cancel-button]:appearance-none"
        />
