          ...
          return (
            <li key={collection}>
              <button
                ...
                className={`flex w-full items-center justify-between gap-2 rounded-lg px-2.5 py-2 text-left text-xs font-semibold transition-colors duration-200 ${
                  isActive
              ...
              >
                <span className="truncate">{presetCollectionLabel(collection)}</span>
                <span className={`font-mono text-2xs ${isActive ? 'text-foundry-950/70' : 'text-ink-faint'}`}>
                  {count}
                </span>
              </button>
            </li>
