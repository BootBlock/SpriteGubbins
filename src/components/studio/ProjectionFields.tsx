 ...
 * PORTRAIT, BACKGROUND and FONT are each offered `ORTHOGRAPHIC_FRONT` alone — a bust is read at eye
 * level, a backdrop is a plane standing at a distance, and a glyph is a flat mark an engine blits as
 * it was drawn — and the other nine are offered every camera,
 ...
 * is the category's: an interface widget, a ground tile, an icon, a backdrop band, a portrait and a
 * glyph have no facing to turn to, so those six offer `SINGLE_FRONT` alone, and the control stays on
