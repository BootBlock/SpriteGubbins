 ...
 * treatment, as `SheetStepButtons` spells it — `text-ink-faint` with the hover and the lift put back
 * where they started — keyed to `aria-disabled` rather than to `disabled`, for the reason
