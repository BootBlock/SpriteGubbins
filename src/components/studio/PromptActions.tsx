 ...
 */
const PROMPT_ACTION =
  'group flex items-center gap-1.5 rounded-xl border border-foundry-600 bg-foundry-950 px-3 py-1.5 text-xs font-semibold text-ink-muted transition-all duration-300 hover:-translate-y-px hover:border-tab/50 hover:bg-foundry-700 hover:text-ink active:translate-y-0';

/** The glyph inside one of those, lifting with it — which is why each button is a `group`. */
const PROMPT_ACTION_ICON = 'inline-block transition-transform duration-450 group-hover:scale-125';
  ...
  return (
    <div className="mb-3 flex flex-wrap items-center gap-2">
      ...
      <button
        ...
        className="action-tab group relative ml-auto overflow-hidden rounded-xl px-4 py-1.5 text-xs font-extrabold transition-all duration-300 hover:scale-[1.03] active:scale-[0.98]"
      >
