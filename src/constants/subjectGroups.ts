 ...
 * *Ornament & Trim*, *Scatter Layer*, *Garments At The Shoulders*, *Applied Overlay*, *Applied
 * Atmosphere* and *Applied Treatment* — which is why this group is **Features & fittings** (every
 ...
 * The wording that covered the first six categories survived neither. What every one of them shares
 * is the weaker, truer property above: the slot holds whatever sits *over* the subject's base form.
 * The heading did not have to move for that, which is the point of checking it against every
 * category rather than against the one the group was written from.
 *
