 ...
 * exhaustive, which is the property worth the extra file: a fourth mode added to `PREVIEW_MODES`
 ...
 * do rather than what they contain, because all three modes contain the same two things.
 */
