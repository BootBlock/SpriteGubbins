 ...
 * of the tile's own cell in the exploded grid — a ground tile is a component the sheet draws, so both
 * of this category's plans set `scaleUnitFrame` to the cell rather than to the sheet — which is a
 * share either way, and still not a pixel count an engine can be handed.
 *
