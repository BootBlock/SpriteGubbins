 ...
 * makes a reading approximate, and it is only ever used to report a ceiling being exceeded many
 * times over, where the estimate's error cannot change the answer.
 */
