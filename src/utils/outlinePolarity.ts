 ...
 * thickness of 2 came to **12.5%** against the **24.4%** the same sheet reaches with the pass
 * switched off. It was deleting the linework it exists to rescue. Reweighting only slides the figure
 * (12.5% at the reference's own 10:3, 14.6% at its 9:4, 22.6% at 5:5, 42.0% at 2:8, and 53.4% with
 ...
 * docblock defines. `tests/quantiser-figures-outline-expansion.test.ts` pins every rung and the 96%.
 *
